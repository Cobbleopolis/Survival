...
!function (e, i, t, n) {
    ...
    e.fn.sidebar = function (o) {
        var r, s = e(this), a = e("head"), l = s.selector || "", c = (new Date).getTime(), u = [], d = arguments[0], f = "string" == typeof d, m = [].slice.call(arguments, 1), b = i.requestAnimationFrame || i.mozRequestAnimationFrame || i.webkitRequestAnimationFrame || i.msRequestAnimationFrame || function (e) {
                setTimeout(e, 0)
            };
        return s.each(function () {
            var s, p, v, g, h = e.isPlainObject(o) ? e.extend(!0, {}, e.fn.sidebar.settings, o) : e.extend({}, e.fn.sidebar.settings), y = h.selector, x = h.className, w = h.namespace, T = h.error, k = "." + w, C = "module-" + w, S = e(this), A = e(h.context), P = S.children(y.sidebar), F = A.children(y.pusher), z = this, O = S.data(C);
            g = {
                initialize: function () {
                ...
                }, attachEvents: function (i, t) {
                    var n = e(i);
                    t = e.isFunction(g[t]) ? g[t] : g.toggle, n.size() > 0 ? (g.debug("Attaching sidebar events to element", i, t), n.on("click" + k, t)) : g.error(T.notFound, i)
                }, show: function (i) {
                    var t = h.useLegacy ? g.legacyPushPage : g.pushPage;
                    i = e.isFunction(i) ? i : function () {
                    }, g.is.closed() ? (h.overlay && (g.error(T.overlay), h.transition = "overlay"), g.refresh(), g.othersVisible() && "overlay" != g.get.transition() && (g.debug("Other sidebars currently open"), h.exclusive && g.hideOthers()), t(function () {
                        e.proxy(i, z)(), e.proxy(h.onShow, z)()
                    }), e.proxy(h.onChange, z)(), e.proxy(h.onVisible, z)()) : g.debug("Sidebar is already visible")
                }, hide: function (i) {
                    var t = h.useLegacy ? g.legacyPullPage : g.pullPage;
                    i = e.isFunction(i) ? i : function () {
                    }, (g.is.visible() || g.is.animating()) && (g.debug("Hiding sidebar", i), t(function () {
                    ...
                    var i = P.not(S).filter("." + x.visible), e = e || function () {
                        }, t = i.size(), n = 0;
                    i.sidebar("hide", function () {
                        n++, n == t && e()
                    })
                }, toggle: function () {
                    g.verbose("Determining toggled direction"), g.is.closed() ? g.show() : g.hide()
                }, pushPage: function (i) {
                    var t, n, o = g.get.transition(), r = "safe" == o ? A : "overlay" == o || g.othersVisible() ? S : F;
                    i = e.isFunction(i) ? i : function () {
                    }, ("scale down" == h.transition || g.is.mobile() && "overlay" !== o) && g.scrollToTop(), g.set.transition(), g.repaint(), t = function () {
                        g.add.bodyCSS(), g.set.animating(), g.set.visible(), g.othersActive() || h.dimPage && F.addClass(x.dimmed)
                    }, n = function (t) {
                        t.target == r[0] && (r.off(v + k, n), g.remove.animating(), g.bind.clickaway(), e.proxy(i, z)())
                    }, r.on(v + k, n), b(t)
                }, pullPage: function (i) {
                    var t, n, o = g.get.transition(), r = "safe" == o ? A : "overlay" == o || g.othersActive() ? S : F;
                    i = e.isFunction(i) ? i : function () {
                    }, g.verbose("Removing context push state", g.get.direction()), g.othersActive() || g.unbind.clickaway(), t = function () {
                        g.set.animating(), g.remove.visible(), h.dimPage && !g.othersActive() && F.removeClass(x.dimmed)
                    }, n = function (t) {
                        t.target == r[0] && (r.off(v + k, n), g.remove.animating(), g.remove.transition(), g.remove.bodyCSS(), ("scale down" == o || h.returnScroll && g.is.mobile()) && g.scrollBack(), e.proxy(i, z)())
                    }, r.on(v + k, n), b(t)
                }, legacyPushPage: function (i) {
                    var t = S.width(), n = g.get.direction(), o = {};
                    t = t || S.width(), i = e.isFunction(i) ? i : function () {
                    }, o[n] = t, g.debug("Using javascript to push context", o), g.set.visible(), g.set.transition(), g.set.animating(), h.dimPage && F.addClass(x.dimmed), A.css("position", "relative").animate(o, h.duration, h.easing, function () {
                        g.remove.animating(), g.bind.clickaway(), e.proxy(i, g)()
                    })
                }, legacyPullPage: function (i) {
                    var t = 0, n = g.get.direction(), o = {};
                    t = t || S.width(), i = e.isFunction(i) ? i : function () {
                    }, o[n] = "0px", g.debug("Using javascript to pull context", o), g.unbind.clickaway(), g.set.animating(), g.remove.visible(), h.dimPage && !g.othersVisible() && F.removeClass(x.dimmed), A.css("position", "relative").animate(o, h.duration, h.easing, function () {
                    ...
                    direction: function () {
                        ...
                        var e = g.get.direction();
                        return g.is.mobile() ? "auto" == h.mobileTransition ? h.defaultTransition.mobile[e] : h.mobileTransition : "auto" == h.transition ? h.defaultTransition.computer[e] : h.transition
                    }, transitionEvent: function () {
                        var e, i = t.createElement("element"), o = {
                            transition: "transitionend",
                            OTransition: "oTransitionEnd",
                            MozTransition: "transitionend",
                            WebkitTransition: "webkitTransitionEnd"
                        };
                        for (e in o)if (i.style[e] !== n)return o[e]
                    }
                }, is: {
                    ie: function () {
                        ...
                        for (var s in r)o.style[s] !== n && (o.style[s] = "translate3d(1px,1px,1px)", e = i.getComputedStyle(o).getPropertyValue(r[s]));
                        return t.body.removeChild(o), !(e !== n && e.length > 0 && "none" !== e)
                    }, mobile: function () {
                        var e = navigator.userAgent, i = /Mobile|iP(hone|od|ad)|Android|BlackBerry|IEMobile|Kindle|NetFront|Silk-Accelerated|(hpw|web)OS|Fennec|Minimo|Opera M(obi|ini)|Blazer|Dolfin|Dolphin|Skyfire|Zune/, t = i.test(e);
                        return t ? (g.verbose("Browser was found to be mobile", e), !0) : (g.verbose("Browser is not mobile, using regular transition", e), !1)
                    }, closed: function () {
                        return !g.is.visible()
                    }, visible: function () {
                    ...
                    log: function (e) {
                        var i, t, n;
                        h.performance && (i = (new Date).getTime(), n = c || i, t = i - n, c = i, u.push({
                            Name: e[0],
                        ...
                        var i = h.name + ":", t = 0;
                        c = !1, clearTimeout(g.performance.timer), e.each(u, function (e, i) {
                            t += i["Execution Time"]
                ...
                }, invoke: function (i, t, o) {
                    var s, a, l, c = O;
                    return t = t || m, o = z || o, "string" == typeof i && c !== n && (i = i.split(/[\. ]/), s = i.length - 1, e.each(i, function (t, o) {
                        var r = t != s ? o + i[t + 1].charAt(0).toUpperCase() + i[t + 1].slice(1) : i;
                        if (e.isPlainObject(c[r]) && t != s)c = c[r]; else {
                            if (c[r] !== n)return a = c[r], !1;
                            if (!e.isPlainObject(c[o]) || t == s)return c[o] !== n ? (a = c[o], !1) : (g.error(T.method, i), !1);
                            c = c[o]
                        }
        ...
        easeInOutQuint: function (e, i, t, n, o) {
