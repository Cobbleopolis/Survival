...
!function (e, t, i, n) {
    e.visit = e.fn.visit = function (i) {
        var o, r = e(e.isFunction(this) ? t : this), s = r.selector || "", a = (new Date).getTime(), c = [], u = arguments[0], d = "string" == typeof u, l = [].slice.call(arguments, 1);
        return r.each(function () {
            var g, m = e.extend(!0, {}, e.fn.visit.settings, i), f = m.error, p = m.namespace, v = p + "-module", h = e(this), y = e(), b = this, k = h.data(v);
            g = {
                initialize: function () {
                    ...
                    var t = g.get.count(), i = +t + 1;
                    e ? g.add.id(e) : (i > m.limit && !m.surpass && (i = m.limit), g.debug("Incrementing visits", i), g.store(m.key.count, i))
                }, decrement: function (e) {
                    var t = g.get.count(), i = +t - 1;
                    e ? g.remove.id(e) : (g.debug("Removing visit"), g.store(m.key.count, i))
                }, get: {
                    count: function () {
                        ...
                        var t = [];
                        return e = e || g.retrieve(m.key.ids), "string" == typeof e && (t = e.split(m.delimiter)), g.verbose("Found visited ID list", t), t
                    }, storageOptions: function () {
                        var e = {};
                        return m.expires && (e.expires = m.expires), m.domain && (e.domain = m.domain), m.path && (e.path = m.path), e
                    }
                }, has: {
                    visited: function (t, i) {
                        var o = !1;
                        return i = i || g.get.ids(), t !== n && i && e.each(i, function (e, i) {
                            i == t && (o = !0)
                        }), o
                    }
                }, set: {
                    ...
                    id: function (e) {
                        var t = g.retrieve(m.key.ids), i = t === n || "" === t ? e : t + m.delimiter + e;
                        g.has.visited(e) ? g.debug("Unique content already visited, not adding visit", e, t) : e === n ? g.debug("ID is not defined") : (g.debug("Adding visit to unique content", e), g.store(m.key.ids, i)), g.set.count(g.get.idCount())
                    }, display: function (t) {
                        var i = e(t);
                        i.size() > 0 && !e.isWindow(i[0]) && (g.debug("Updating visit count for element", i), y = y.size() > 0 ? y.add(i) : i)
                    }
                }, remove: {
                    id: function (t) {
                        var i = g.get.ids(), o = [];
                        t !== n && i !== n && (g.debug("Removing visit to unique content", t, i), e.each(i, function (e, i) {
                            i !== t && o.push(i)
                    ...
                    var r = g.get.storageOptions(o);
                    if ("localstorage" == m.storageMethod && t.localStorage !== n)t.localStorage.setItem(i, o), g.debug("Value stored using local storage", i, o); else {
                        if (e.cookie === n)return void g.error(f.noCookieStorage);
                        e.cookie(i, o, r), g.debug("Value stored using cookie", i, o, r)
                    }
                    i == m.key.count && g.check.limit(o)
                }, retrieve: function (i) {
                    var o;
                    return "localstorage" == m.storageMethod && t.localStorage !== n ? o = t.localStorage.getItem(i) : e.cookie !== n ? o = e.cookie(i) : g.error(f.noCookieStorage), ("undefined" == o || "null" == o || o === n || null === o) && (o = n), o
                    ...
                    log: function (e) {
                        var t, i, n;
                        m.performance && (t = (new Date).getTime(), n = a || t, i = t - n, a = t, c.push({
                            Name: e[0],
                        ...
                        var t = m.name + ":", i = 0;
                        a = !1, clearTimeout(g.performance.timer), e.each(c, function (e, t) {
                            i += t["Execution Time"]
                    ...
                    var s, a, c, u = k;
                    return i = i || l, r = b || r, "string" == typeof t && u !== n && (t = t.split(/[\. ]/), s = t.length - 1, e.each(t, function (i, o) {
                        var r = i != s ? o + t[i + 1].charAt(0).toUpperCase() + t[i + 1].slice(1) : t;
                        if (e.isPlainObject(u[r]) && i != s)u = u[r]; else {
                            if (u[r] !== n)return a = u[r], !1;
                            if (!e.isPlainObject(u[o]) || i == s)return u[o] !== n ? (a = u[o], !1) : !1;
                            u = u[o]
                        }
