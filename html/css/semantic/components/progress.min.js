...
!function (e, t, n, r) {
    ...
    e.fn.progress = function (t) {
        var n, a = e(this), o = a.selector || "", s = (new Date).getTime(), c = [], i = arguments[0], l = "string" == typeof i, u = [].slice.call(arguments, 1);
        return a.each(function () {
            var a, g = e.isPlainObject(t) ? e.extend(!0, {}, e.fn.progress.settings, t) : e.extend({}, e.fn.progress.settings), p = g.className, m = g.metadata, v = g.namespace, d = g.selector, b = g.error, f = "module-" + v, h = e(this), x = e(this).find(d.bar), y = e(this).find(d.progress), w = e(this).find(d.label), C = this, A = h.data(f);
            a = {
                initialize: function () {
                    ...
                    var t, n, r, o = a.total || !1;
                    o ? (n = a.value || 0, e = e || 1, r = n + e, t = a.total, a.debug("Incrementing value by", e, n, t), r > t && (a.debug("Value cannot increment above total", t), r = t), a.set.progress(r)) : (n = a.percent || 0, e = e || a.get.randomValue(), r = n + e, t = 100, a.debug("Incrementing percentage by", e, n), r > t && (a.debug("Value cannot increment above 100 percent"), r = t), a.set.progress(r))
                }, decrement: function (e) {
                    var t, n, r = a.total || !1, o = 0;
                    r ? (t = a.value || 0, e = e || 1, n = t - e, a.debug("Decrementing value by", e, t)) : (t = a.percent || 0, e = e || a.get.randomValue(), n = t - e, a.debug("Decrementing percentage by", e, t)), o > n && (a.debug("Value cannot decrement below 0"), n = 0), a.set.progress(n)
                }, get: {
                    text: function (e) {
                        var t = a.value || 0, n = a.total || 0, r = a.percent || 0;
                        return e = e || "", e = e.replace("{value}", t).replace("{total}", n).replace("{percent}", r), a.debug("Adding variables to progress bar text", e), e
                    ...
                    barWidth: function (e) {
                        ...
                        n || a.error(b.nonNumeric), a.total ? (a.value = n, t = n / a.total * 100, a.debug("Calculating percent complete from total", t), a.set.percent(t)) : (t = n, a.debug("Setting value to exact percentage value", t), a.set.percent(t))
                    }
                    ...
                    log: function (e) {
                        var t, n, r;
                        g.performance && (t = (new Date).getTime(), r = s || t, n = t - r, s = t, c.push({
                            Name: e[0],
                    ...
                    var c, i, l, g = A;
                    return o = o || u, s = C || s, "string" == typeof t && g !== r && (t = t.split(/[\. ]/), c = t.length - 1, e.each(t, function (n, o) {
                        var s = n != c ? o + t[n + 1].charAt(0).toUpperCase() + t[n + 1].slice(1) : t;
                        if (e.isPlainObject(g[s]) && n != c)g = g[s]; else {
                            if (g[s] !== r)return i = g[s], !1;
                            if (!e.isPlainObject(g[o]) || n == c)return g[o] !== r ? (i = g[o], !1) : (a.error(b.method, t), !1);
                            g = g[o]
                        }
