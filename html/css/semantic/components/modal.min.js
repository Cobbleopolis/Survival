...
!function (e, i, n, o) {
    ...
    e.fn.modal = function (t) {
        var s, a = e(this), r = e(i), c = e(n), l = e("body"), u = a.selector || "", d = (new Date).getTime(), m = [], f = arguments[0], g = "string" == typeof f, h = [].slice.call(arguments, 1), b = i.requestAnimationFrame || i.mozRequestAnimationFrame || i.webkitRequestAnimationFrame || i.msRequestAnimationFrame || function (e) {
                setTimeout(e, 0)
            };
        return a.each(function () {
            var a, v, p, y, k, w, x, H = e.isPlainObject(t) ? e.extend(!0, {}, e.fn.modal.settings, t) : e.extend({}, e.fn.modal.settings), S = H.selector, z = H.className, C = H.namespace, D = H.error, A = "." + C, F = "module-" + C, M = e(this), T = e(H.context), O = M.find(S.close), E = this, j = M.data(F);
            x = {
                initialize: function () {
                    return x.verbose("Initializing dimmer", T), e.fn.dimmer === o ? void x.error(D.dimmer) : (y = T.dimmer({
                        debug: H.debug,
                        dimmerName: "modals",
                        closable: !1,
                        useCSS: !0,
                        duration: {show: .9 * H.duration, hide: 1.1 * H.duration}
                    }), H.detachable && y.dimmer("add content", M), k = y.dimmer("get dimmer"), v = M.siblings(S.modal), a = v.add(M), x.verbose("Attaching close events", O), x.bind.events(), x.observeChanges(), void x.instantiate())
                ...
                }, attachEvents: function (i, n) {
                    var o = e(i);
                    n = e.isFunction(x[n]) ? x[n] : x.toggle, o.size() > 0 ? (x.debug("Attaching modal events to element", i, n), o.off(A).on("click" + A, n)) : x.error(D.notFound, i)
                }, bind: {
                    events: function () {
                    ...
                    close: function () {
                        ...
                        var i = e.which, n = 27;
                        i == n && (H.closable ? (x.debug("Escape key pressed hiding modal"), x.hide()) : x.debug("Escape key pressed, but closable is set to false"), e.preventDefault())
                    }, resize: function () {
                    ...
                    }, x.showDimmer(), x.showModal(i)
                }, showModal: function (i) {
                    i = e.isFunction(i) ? i : function () {
                    }, x.is.active() ? x.debug("Modal is already visible") : v.filter(":visible").size() > 0 && !H.allowMultiple ? (x.debug("Other modals visible, queueing show animation"), x.hideOthers(x.showModal)) : (e.proxy(H.onShow, E)(), H.transition && e.fn.transition !== o && M.transition("is supported") ? (x.debug("Showing modal with css animations"), x.cacheSizes(), x.set.position(), x.set.screenHeight(), x.set.type(), M.transition({
                        debug: H.debug,
                    ...
                    i = e.isFunction(i) ? i : function () {
                    }, a.filter(":visible").size() <= 1 && x.hideDimmer(), x.hideModal(i)
                }, hideDimmer: function () {
                    ...
                    i = e.isFunction(i) ? i : function () {
                    }, x.debug("Hiding modal"), e.proxy(H.onHide, E)(), H.transition && e.fn.transition !== o && M.transition("is supported") ? M.transition({
                        debug: H.debug,
                    ...
                    i = e.isFunction(i) ? i : function () {
                    }, a.is(":visible") && (x.debug("Hiding all visible modals"), x.hideDimmer(), a.filter(":visible").modal("hide modal", i))
                }, hideOthers: function (i) {
                    i = e.isFunction(i) ? i : function () {
                    }, v.is(":visible") && (x.debug("Hiding other modals", v), v.filter(":visible").modal("hide modal", i))
                }, add: {
                    ...
                    var t = M.outerHeight();
                    (x.cache === o || 0 !== t) && (x.cache = {
                        pageHeight: e(n).outerHeight(),
                        height: t + H.offset,
                        contextHeight: "body" == H.context ? e(i).height() : y.height()
                    }), x.debug("Caching modal and container sizes", x.cache)
                }, can: {
                    fit: function () {
                    ...
                    autofocus: function () {
                        if (H.autofocus) {
                            var e = M.find(":input:visible"), i = e.filter("[autofocus]"), n = i.size() > 0 ? i : e;
                            n.first().focus()
                        }
                    }, clickaway: function () {
                        ...
                        x.verbose("Centering modal on page", x.cache), M.css(x.can.fit() ? {
                            top: "",
                            marginTop: -(x.cache.height / 2)
                    ...
                    log: function (e) {
                        var i, n, o;
                        H.performance && (i = (new Date).getTime(), o = d || i, n = i - o, d = i, m.push({
                            Name: e[0],
                        ...
                        var i = H.name + ":", n = 0;
                        d = !1, clearTimeout(x.performance.timer), e.each(m, function (e, i) {
                            n += i["Execution Time"]
                ...
                }, invoke: function (i, n, t) {
                    var a, r, c, l = j;
                    return n = n || h, t = E || t, "string" == typeof i && l !== o && (i = i.split(/[\. ]/), a = i.length - 1, e.each(i, function (n, t) {
                        var s = n != a ? t + i[n + 1].charAt(0).toUpperCase() + i[n + 1].slice(1) : i;
                        if (e.isPlainObject(l[s]) && n != a)l = l[s]; else {
                            if (l[s] !== o)return r = l[s], !1;
                            if (!e.isPlainObject(l[t]) || n == a)return l[t] !== o ? (r = l[t], !1) : !1;
                            l = l[t]
                        }
