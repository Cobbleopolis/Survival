...
!function (e, t, a, n) {
    ...
    e.tab = e.fn.tab = function (a) {
        var i, o, r = e(e.isFunction(this) ? t : this), s = e.isPlainObject(a) ? e.extend(!0, {}, e.fn.tab.settings, a) : e.extend({}, e.fn.tab.settings), c = r.selector || "", u = (new Date).getTime(), l = [], d = arguments[0], b = "string" == typeof d, g = [].slice.call(arguments, 1);
        return r.each(function () {
            var a, f, p, h, m, v = s.className, y = s.metadata, T = s.selector, x = s.error, A = "." + s.namespace, P = "module-" + s.namespace, C = e(this), E = {}, S = !0, w = 0, z = this, j = C.data(P);
            i = {
                initialize: function () {
                    i.debug("Initializing tab menu item", C), i.determineTabs(), i.debug("Determining tabs", s.context, f), s.auto && (i.verbose("Setting up automatic tab retrieval from server"), s.apiSettings = {url: s.path + "/{$tab}"}), e.isWindow(z) || (i.debug("Attaching tab activation events to element", C), C.on("click" + A, i.event.click)), i.instantiate()
                    ...
                    click: function (t) {
                        ...
                        change: function (t) {
                            var a = t.pathNames.join("/") || i.get.initialPath(), o = s.templates.determineTitle(a) || !1;
                    ...
                    var o = t.history && t.history.pushState, r = o && s.ignoreFirstLoad && S, c = s.auto || e.isPlainObject(s.apiSettings), u = c && !r ? i.utilities.pathToArray(n) : i.get.defaultPathArray(n);
                    n = i.utilities.arrayToPath(u), e.each(u, function (t, o) {
                        var l, d, b, g, f = u.slice(0, t + 1), v = i.utilities.arrayToPath(f), y = i.is.tab(v), T = t + 1 == u.length, A = i.get.tabElement(v);
                    ...
                    fetch: function (t, a) {
                        var o, r, c = i.get.tabElement(t), u = {
                            dataType: "html", stateContext: c, onSuccess: function (n) {
                    ...
                    initialPath: function () {
                        ...
                        var t = r.filter("[data-" + y.tab + '^="' + e + '/"]').eq(0), a = t.data(y.tab) || !1;
                        if (a) {
                    ...
                    return a = a || g, r = z || r, "string" == typeof t && l !== n && (t = t.split(/[\. ]/), s = t.length - 1, e.each(t, function (a, o) {
                        ...
                        if (e.isPlainObject(l[r]) && a != s)l = l[r]; else {
